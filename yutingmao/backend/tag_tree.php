			...
			<div id="container">
        		<div id="sidebar">
                	<ul class="sideNav">
                    	...
                    	<li><a href="tag_tree.php" class="active"  >Tag Tree </a></li>
                ...
                <h2><a href="#">Administrator</a> &raquo; <a href="#" class="active">Tag Tree </a></h2>
                
              <div id="main">
                	
					<h3>The Current Tags</h3>
					 <fieldset>
				  <?php while($row = mysql_fetch_assoc($result)){ ?>
				  <form action="delete_tag.php" class="jNice" method="post">
				   <table width="262"  border="1">
					  <tr>
					    <td width="348" > <?php echo $row['tag_name'];?>&nbsp;</td>
					    <td width="198">  <input type="hidden" name="id" value="<?php echo $row['tag_name'];?>">
